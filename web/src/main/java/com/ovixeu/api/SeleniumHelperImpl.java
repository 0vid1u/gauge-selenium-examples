...
import com.ovixeu.core.Browser;
...
public class SeleniumHelperImpl implements SeleniumHelper {
    ...
    public SeleniumHelperImpl(final Browser browser,
                              final WebDriver driver,
                              final WebDriverWait webDriverWait,
                              final String pathToScreenshot,
                              final String relativeScreenshotPath) {
        this.driver = driver;
    ...
    public void resizeBrowser(BrowserType browserType) {
        driver.manage().window().setSize(browser.getDimension(browserType));
    }
     ...
     */
    public File getScreenShot(WebDriver driver, String filename) {
        File imageFile = null;
        try {
            createScreenShotDir();
    ...
    public void click(WebElement element) {
        ...
        if (webElement != null) {
            ...
            Assert.assertNotNull("Element for click not found");
        }
    }
